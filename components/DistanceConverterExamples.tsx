...
export default function DistanceConverterExamples() {
  const t = useTranslations('distanceConverter');

  const examples = [
    {
      title: t('examples.metersToKm.title'),
      description: t('examples.metersToKm.description'),
      value: '1000',
      fromUnit: 'meters',
      toUnit: 'kilometers',
      result: t('examples.metersToKm.result')
    },
    {
      title: t('examples.feetToMeters.title'),
      description: t('examples.feetToMeters.description'),
      value: '10',
      fromUnit: 'feet',
      toUnit: 'meters',
      result: t('examples.feetToMeters.result')
    },
    {
      title: t('examples.milesToKm.title'),
      description: t('examples.milesToKm.description'),
      value: '5',
      fromUnit: 'miles',
      toUnit: 'kilometers',
      result: t('examples.milesToKm.result')
    },
    {
      title: t('examples.inchesToCm.title'),
      description: t('examples.inchesToCm.description'),
      value: '12',
      fromUnit: 'inches',
      toUnit: 'centimeters',
      result: t('examples.inchesToCm.result')
    },
    {
      title: t('examples.yardsToMeters.title'),
      description: t('examples.yardsToMeters.description'),
      value: '100',
      fromUnit: 'yards',
      toUnit: 'meters',
      result: t('examples.yardsToMeters.result')
    },
    {
      title: t('examples.smallUnits.title'),
      description: t('examples.smallUnits.description'),
      value: '1',
      fromUnit: 'millimeters',
      toUnit: 'inches',
      result: t('examples.smallUnits.result')
    }
  ];
