...
export default function SpeedCalculatorExamples() {
  ...
  const examples = [
    {
      id: 'movie',
      title: t('examples.movie'),
      result: t('examples.movieResult'),
      icon: (
    ...
    {
      id: 'album',
      title: t('examples.album'),
      result: t('examples.albumResult'),
      icon: (
        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      id: 'document',
      title: t('examples.document'),
      result: t('examples.documentResult'),
      icon: (
        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {examples.map((example) => (
          <button
            ...
            className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group w-full text-left cursor-pointer"
          >
