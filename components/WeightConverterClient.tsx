...
export default function WeightConverterClient() {
  ...
  const config: CalculatorConfig = useMemo(() => ({
    ...
    input1: {
      ...
      unit: fromUnit,
      units: [
        {value: 'milligrams', label: t('units.milligrams')},
        {value: 'grams', label: t('units.grams')},
        {value: 'kilograms', label: t('units.kilograms')},
        {value: 'pounds', label: t('units.pounds')},
        {value: 'ounces', label: t('units.ounces')},
        {value: 'tons', label: t('units.tons')},
        {value: 'stone', label: t('units.stone')}
      ],
      onChange: setValue,
