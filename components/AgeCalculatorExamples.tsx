...
export default function AgeCalculatorExamples() {
  const t = useTranslations('ageCalc');

  const examples = [
    {
      title: t('examples.birthday.title'),
      description: t('examples.birthday.description'),
      birthday: '1990-05-15',
      currentDate: '2024-01-15',
      result: t('examples.birthday.result')
    },
    {
      title: t('examples.recentBirthday.title'),
      description: t('examples.recentBirthday.description'),
      birthday: '1985-12-01',
      currentDate: '2024-01-15',
      result: t('examples.recentBirthday.result')
    },
    {
      title: t('examples.futureBirthday.title'),
      description: t('examples.futureBirthday.description'),
      birthday: '2000-06-20',
      currentDate: '2024-01-15',
      result: t('examples.futureBirthday.result')
    },
    {
              ...
              <div className="flex-1">
                ...
                <div className="bg-purple-50 rounded-lg p-4 mb-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="font-medium text-purple-900">{t('examples.birthdayLabel')}:</span>
                      <div className="text-purple-700">{example.birthday}</div>
                    </div>
                    <div>
                      <span className="font-medium text-purple-900">{t('examples.currentDateLabel')}:</span>
                      <div className="text-purple-700">{example.currentDate}</div>
                    </div>
                  </div>
                </div>
